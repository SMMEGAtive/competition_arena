...
List<StatisticData> statisticDataFromJson(String str) => List<StatisticData>.from(json.decode(str).map((x) => StatisticData.fromJson(x)));

String statisticDataToJson(List<StatisticData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class StatisticData {
    ...
    factory StatisticData.fromJson(Map<String, dynamic> json) => StatisticData(
        ...
        competitionWon: List<CompetitionWon>.from(json["Competition_Won"].map((x) => CompetitionWon.fromJson(x))),
        participationCount: json["Participation_Count"],
        participation: List<Participation>.from(json["Participation"].map((x) => Participation.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "Win_Count": winCount,
        "Win_Ratio": winRatio,
        "Competition_Won": List<dynamic>.from(competitionWon.map((x) => x.toJson())),
        "Participation_Count": participationCount,
        "Participation": List<dynamic>.from(participation.map((x) => x.toJson())),
    };
}
